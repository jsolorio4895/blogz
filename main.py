...
app.config["SQLALCHEMY_DATABASE_URI"] = "mysql+pymysql://blogz:40100bb@localhost:8889/blogz"
app.config["SQLALCHEMY_ECHO"] = True
db = SQLAlchemy(app)

app.secret_key = 'thisappissupersecret'
...
def signup():
    if request.method == 'POST':
        ...
        if not is_email(email):
            flash('Oopsie! "' + email + '" does not seem like an email address')
